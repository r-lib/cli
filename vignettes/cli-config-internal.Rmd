...
These are env vars and options are for cli developers, users should not
rely of them as they may change between cli releases.
...
interpolatinf the format string.
