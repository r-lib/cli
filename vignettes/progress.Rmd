...
```{asciicast, asciicast-tick-time, include = FALSE, cache = FALSE}
set.seed(1)
...
```{asciicast current}
#| R.options = modifyList(.cast_opts, list(asciicast_omit_last_line = TRUE))
clean <- function() {
...
#| R.options = c(.cast_opts, list(asciicast_rows = 3))
f <- function() {
