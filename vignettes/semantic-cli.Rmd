...
```{asciicast}
#| R.options = modifyList(keep.null = TRUE, .cast_opts, list(asciicast_at = NULL, asciicast_end_wait = 30))
f <- function() {
...
```{asciicast}
#| R.options = modifyList(keep.null = TRUE, .cast_opts, list(asciicast_at = NULL))
