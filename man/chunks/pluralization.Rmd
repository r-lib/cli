...
The exact rules of cli's pluralization.
...
1.  `{}` substitutions define quantities.
    If the value of a `{}` substitution is numeric (i.e. `is.numeric(x)` holds), then it has to have length one to define a quantity.
