...
In some terminal emulators (e.g. iTerm2), you can configure the preferred behavior.
...
If you don't want to change your font, you can also turn off Unicope output, by setting the `cli.unicode` option:
```r
...
If some output is garbled, then cli probably mis-detected Unicode support for your terminal or font.
...
options(cli.unicode = FALSE)
```
If you think this is cli's fault, then please also file an issue at https://github.com/r-lib/cli/issues
