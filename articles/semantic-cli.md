...
[`cli_end()`](https://cli.r-lib.org/reference/cli_end.md) closes the
...
[`cli_end()`](https://cli.r-lib.org/reference/cli_end.md) call is not
needed. Use `.auto_close = FALSE` in
[`cli_par()`](https://cli.r-lib.org/reference/cli_par.md) to leave the
...
an empty line after
[`cli_h1()`](https://cli.r-lib.org/reference/cli_h1.md) and
...
[`cli_format()`](https://cli.r-lib.org/reference/cli_format.md) to
...
see [`cli_ol()`](https://cli.r-lib.org/reference/cli_ol.md),
[`cli_ul()`](https://cli.r-lib.org/reference/cli_ul.md) and
...
The [`cli_ul()`](https://cli.r-lib.org/reference/cli_ul.md) call creates
a list container, and because its items are not specified, it leaves the
container open. Then items can be added one by one. (The last
[`cli_end()`](https://cli.r-lib.org/reference/cli_end.md) is not
necessary, because by default containers auto-close when their calling
function exits.)

#### Adding text to an item iteratively

[`cli_li()`](https://cli.r-lib.org/reference/cli_li.md) creates a new
container for the list item, within the list container. You can keep
adding text to the item, until the container is closed via
[`cli_end()`](https://cli.r-lib.org/reference/cli_end.md) or a new
[`cli_li()`](https://cli.r-lib.org/reference/cli_li.md), which closes
...
[`cli_end()`](https://cli.r-lib.org/reference/cli_end.md) would only
close the container of the list item.

### Horizontal rules

[`cli_rule()`](https://cli.r-lib.org/reference/cli_rule.md) creates a
horizontal rule.
...
- `line-type` specifies the line type of the rule. See
  [`?cli_rule`](https://cli.r-lib.org/reference/cli_rule.md) for line
  types.
...
[`cli_status()`](https://cli.r-lib.org/reference/cli_status.md) creates
a new status bar,
...
clears it.
[`cli_status()`](https://cli.r-lib.org/reference/cli_status.md) returns
an id, that can be used in
[`cli_status_update()`](https://cli.r-lib.org/reference/cli_status_update.md)
and
[`cli_status_clear()`](https://cli.r-lib.org/reference/cli_status_clear.md)
...
classes. E.g. [`cli_par()`](https://cli.r-lib.org/reference/cli_par.md)
creates a node with a `<p>` tag,
[`cli_ol()`](https://cli.r-lib.org/reference/cli_ol.md) creates a node
with an `<ol>` tag, etc. Here is an example CLI tree. It always starts
with a `<body>` tag with id `"body"`, this is created automatically.
...
the reference and
[`?cli::simple_theme`](https://cli.r-lib.org/reference/simple_theme.md)
for an example theme.

### Generic containers

[`cli_div()`](https://cli.r-lib.org/reference/cli_div.md) is a generic
container, that does not produce any output, but it can add a new theme.
This theme is removed when the `<div>` node is closed. (Like other
containers, [`cli_div()`](https://cli.r-lib.org/reference/cli_div.md)
...
example a [`cli_alert()`](https://cli.r-lib.org/reference/cli_alert.md)
call emits an R condition with class `cli_message`. These messages can
be caught, muffled, transferred from a sub-process to the main R
process.
...
and [`get_spinner()`](https://cli.r-lib.org/reference/get_spinner.md).
From the awesome
