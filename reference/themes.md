...
2.  When an app object is created via
    [`start_app()`](https://cli.r-lib.org/reference/start_app.md), the
    caller can specify a theme, that is added to theme stack. If no
    theme is specified for
    [`start_app()`](https://cli.r-lib.org/reference/start_app.md), the
    content of the `cli.theme` option is used. Removed when the
...
4.  Themes specified explicitly in
    [`cli_div()`](https://cli.r-lib.org/reference/cli_div.md) elements.
    These are removed from the theme stack, when the corresponding
    [`cli_div()`](https://cli.r-lib.org/reference/cli_div.md) elements
    are closed.
...
[`builtin_theme()`](https://cli.r-lib.org/reference/builtin_theme.md)
and [`simple_theme()`](https://cli.r-lib.org/reference/simple_theme.md)
for examples.
