...
See [`is_ansi_tty()`](https://cli.r-lib.org/reference/is_ansi_tty.md).
...
[themes](https://cli.r-lib.org/reference/themes.md) and
...
[`cli_end()`](https://cli.r-lib.org/reference/cli_end.md) calls when
