...
functions, see [ANSI
styles](https://cli.r-lib.org/reference/ansi-styles.md), and the
...
- col:
  ...
  or a color name that is passed to
...
- line_col, background_col:
  ...
  styles](https://cli.r-lib.org/reference/ansi-styles.md)), to color the
  line and background.
