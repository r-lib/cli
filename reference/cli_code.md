...
[`cli_verbatim()`](https://cli.r-lib.org/reference/cli_verbatim.md) to
output code lines. The builtin theme formats these containers specially.
In particular, it adds syntax highlighting to valid R code.
...
- .auto_close:
  ...
  Passed to [`cli_div()`](https://cli.r-lib.org/reference/cli_div.md)
  when creating the container of the code. By default the code container
  is closed after emitting `lines` and `...` via
  [`cli_verbatim()`](https://cli.r-lib.org/reference/cli_verbatim.md).
  You can keep that container open with `.auto_close` and/or `.envir`,
  and then calling
  [`cli_verbatim()`](https://cli.r-lib.org/reference/cli_verbatim.md) to
  add (more) code. Note that the code will be formatted and syntax
...
- .envir:
  ...
  Passed to [`cli_div()`](https://cli.r-lib.org/reference/cli_div.md)
  when creating the container of the code.
