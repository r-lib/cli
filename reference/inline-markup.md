...
- `email` for an email address. If the terminal supports ANSI hyperlinks
  ...
  [links](https://cli.r-lib.org/reference/links.md) for more information
  about cli hyperlinks.
...
theme), it calls the
[`cli_format()`](https://cli.r-lib.org/reference/cli_format.md) generic
function, with the current style as the argument. See
[`cli_format()`](https://cli.r-lib.org/reference/cli_format.md) for
examples.
