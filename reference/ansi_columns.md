...
[`boxx()`](https://cli.r-lib.org/reference/boxx.md), see the example
below.
...
- type:
  ...
  [`ansi_align()`](https://cli.r-lib.org/reference/ansi_align.md). Most
  probably you want the default, `"width"`.
