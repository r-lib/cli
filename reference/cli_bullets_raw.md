...
[`cli_bullets()`](https://cli.r-lib.org/reference/cli_bullets.md), but
it does not perform any inline styling or glue substitutions in the
input.
...
See [`cli_bullets()`](https://cli.r-lib.org/reference/cli_bullets.md)
for examples.
