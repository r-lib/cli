...
[`ansi_nchar()`](https://cli.r-lib.org/reference/ansi_nchar.md), etc.)
we check what the current version of R thinks about the width of these
characters, and then create a regex that matches the ones that R is
wrong about (`re_bad_char_width`).
...
[`ansi_align()`](https://cli.r-lib.org/reference/ansi_align.md) and
[`ansi_strtrim()`](https://cli.r-lib.org/reference/ansi_strtrim.md) as
well.
