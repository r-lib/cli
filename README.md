...
-   [Building a command line
    ...
    -   [Inline lists of items](#inline-lists-of-items)
...
-   `color` is used for the color of the rule *and* the labels. (Use
    color within the label text for a different label color.)
...
<img src="man/figures/README/unnamed-chunk-80.svg" width="100%" />
