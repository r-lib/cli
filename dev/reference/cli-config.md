...
is the helper that forms these links, but it is more common to request
them indirectly via inline markup (documented in
[`help("links")`](https://cli.r-lib.org/dev/reference/links.md)).
...
- a [`sink()`](https://rdrr.io/r/base/sink.html) call for the stream.
...
See
[`num_ansi_colors()`](https://cli.r-lib.org/dev/reference/num_ansi_colors.md).
See also the `cli.num_colors` option.
...
Number of ANSI colors. See
[`num_ansi_colors()`](https://cli.r-lib.org/dev/reference/num_ansi_colors.md).
See also the `cli.default_num_colors` option.
...
Default spinner to use, see
[`get_spinner()`](https://cli.r-lib.org/dev/reference/get_spinner.md).

#### `cli.spinner_ascii`

Default spinner to use on ASCII terminals, see
[`get_spinner()`](https://cli.r-lib.org/dev/reference/get_spinner.md).

#### `cli.spinner_unicode`

Default spinner to use on Unicode terminals, see
[`get_spinner()`](https://cli.r-lib.org/dev/reference/get_spinner.md).

#### `cli.theme`

Default cli theme, in addition to the built-in theme. This option in
intended for the package developers. See
[themes](https://cli.r-lib.org/dev/reference/themes.md) and
...
cli user theme. This option is intended for end users. See
...
[`cli_end()`](https://cli.r-lib.org/dev/reference/cli_end.md) calls when
there is no container to close.
...
Can be used to speed up cli's timer. It is a factor, e.g. setting it to
2 makes cli's time go twice as fast.
...
by cli, when the new options are not set. See
[`num_ansi_colors()`](https://cli.r-lib.org/dev/reference/num_ansi_colors.md).

#### `crayon.enabled`

Deprecated option to turn ANSI colors on/off. This is still supported by
cli when the new options are not set. See
[`num_ansi_colors()`](https://cli.r-lib.org/dev/reference/num_ansi_colors.md).
