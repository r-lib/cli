...
[`cli_par()`](https://cli.r-lib.org/dev/reference/cli_par.md), the list
elements: [`cli_ul()`](https://cli.r-lib.org/dev/reference/cli_ul.md),
[`cli_ol()`](https://cli.r-lib.org/dev/reference/cli_ol.md),
[`cli_dl()`](https://cli.r-lib.org/dev/reference/cli_dl.md), and list
items are containers as well:
...
[`cli_end()`](https://cli.r-lib.org/dev/reference/cli_end.md). For
