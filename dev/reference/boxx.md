...
- label:
  ...
  see [ANSI styles](https://cli.r-lib.org/dev/reference/ansi-styles.md)
...
- col:
  ...
  [ANSI styles](https://cli.r-lib.org/dev/reference/ansi-styles.md)) or
  a color name that is passed to
...
- background_col:
  ...
  color name which will be used in
  [`make_ansi_style()`](https://cli.r-lib.org/dev/reference/make_ansi_style.md)
