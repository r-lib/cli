...
option (see
[cli-config](https://cli.r-lib.org/dev/reference/cli-config.md)) to
change this.
...
[`cli_alert()`](https://cli.r-lib.org/dev/reference/cli_alert.md) etc.
cli functions which will print the text to the console.

### Custom formats

In addition to the builtin types, you can also specify a custom format
string. In this case [progress
variables](https://cli.r-lib.org/dev/reference/progress-variables.md)
