...
[`cli_code()`](https://cli.r-lib.org/dev/reference/cli_code.md) produces
...
[`cli_text()`](https://cli.r-lib.org/dev/reference/cli_text.md) is fine
for this. One difference is that
[`cli_text()`](https://cli.r-lib.org/dev/reference/cli_text.md) will
...
[`cli_abort()`](https://cli.r-lib.org/dev/reference/cli_abort.md) does
the same and is formatted using
...
[`cli_ul()`](https://cli.r-lib.org/dev/reference/cli_ul.md) or
[`cli_alert_info()`](https://cli.r-lib.org/dev/reference/cli_alert.md)
...
[`cli_warn()`](https://cli.r-lib.org/dev/reference/cli_abort.md) does
the same and is formatted using
[`cli_bullets()`](https://cli.r-lib.org/dev/reference/cli_bullets.md).
