...
[`cli::is_dynamic_tty()`](https://cli.r-lib.org/dev/reference/is_dynamic_tty.md)
...
1.  [`cli_progress_bar()`](https://cli.r-lib.org/dev/reference/cli_progress_bar.md)
    creates a progress bar.
2.  [`cli_progress_update()`](https://cli.r-lib.org/dev/reference/cli_progress_bar.md)
    updates a progress bar.
3.  [`cli_progress_done()`](https://cli.r-lib.org/dev/reference/cli_progress_bar.md)
    terminates it.
