...
- cli now shows progress bars after one second by default, if they are
  ...
  for details ([\#542](https://github.com/r-lib/cli/issues/542)).
...
- New [`keypress()`](https://cli.r-lib.org/dev/reference/keypress.md)
...
- New experimental styles to create ANSI hyperlinks in RStudio and
  ...
  [`?cli::links`](https://cli.r-lib.org/dev/reference/links.md) for
  details ([\#513](https://github.com/r-lib/cli/issues/513)).
...
- Nested [`cli()`](https://cli.r-lib.org/dev/reference/cli.md) calls
  work now ([\#497](https://github.com/r-lib/cli/issues/497)).

- Return values now work as they should within
  [`cli()`](https://cli.r-lib.org/dev/reference/cli.md) calls
...
- [`cli_abort()`](https://cli.r-lib.org/dev/reference/cli_abort.md) now
...
- [`cli_dl()`](https://cli.r-lib.org/dev/reference/cli_dl.md) and its
  corresponding
  [`cli_li()`](https://cli.r-lib.org/dev/reference/cli_li.md) can now
  style the labels.
...
- Functions that apply bright background colors
  (e.g. [`bg_br_yellow()`](https://cli.r-lib.org/dev/reference/ansi-styles.md))
...
- [`cli_abort()`](https://cli.r-lib.org/dev/reference/cli_abort.md) has
  been updated to work nicely with rlang 1.0. The default `call` and
  backtrace soft-truncation are set to `.envir` (which itself is set to
  the immediate caller of
  [`cli_abort()`](https://cli.r-lib.org/dev/reference/cli_abort.md) by
  default).
...
- Several improvements and changes in the `ansi_*()` functions:
  ...
  - new function
    [`ansi_html()`](https://cli.r-lib.org/dev/reference/ansi_html.md) to
...
- New functions for hashing:
  ...
  and [`hash_md5()`](https://cli.r-lib.org/dev/reference/hash_md5.md).

- New [`diff_chr()`](https://cli.r-lib.org/dev/reference/diff_chr.md)
  and [`diff_str()`](https://cli.r-lib.org/dev/reference/diff_str.md)
  functions to calculate the difference of character vectors and letters
  of strings.
...
- [`cli_dl()`](https://cli.r-lib.org/dev/reference/cli_dl.md) now works
  with an empty description, and gives a better error for invalid input
  ([\#347](https://github.com/r-lib/cli/issues/347)).

- [`rule()`](https://cli.r-lib.org/dev/reference/rule.md) is now works
...
- New [`cli_abort()`](https://cli.r-lib.org/dev/reference/cli_abort.md),
  [`cli_warn()`](https://cli.r-lib.org/dev/reference/cli_abort.md) and
...
- New `style_no_*()` functions to locally undo styling. New
  [`col_none()`](https://cli.r-lib.org/dev/reference/ansi-styles.md) and
...
- `cli_memo()` was renamed to
  ...
  as it is by default formatted as a bullet list
...
- [`tree()`](https://cli.r-lib.org/dev/reference/tree.md) now does not
...
- New [`cli::cli()`](https://cli.r-lib.org/dev/reference/cli.md)
  function to create a single cli message from multiple cli calls
...
- New [`spark_bar()`](https://cli.r-lib.org/dev/reference/spark_bar.md)
  and
...
- [`cli_h1()`](https://cli.r-lib.org/dev/reference/cli_h1.md),
  [`cli_h2()`](https://cli.r-lib.org/dev/reference/cli_h1.md) and
  [`cli_h3()`](https://cli.r-lib.org/dev/reference/cli_h1.md) now work
  with multiple glue substitutions
...
- [`boxx()`](https://cli.r-lib.org/dev/reference/boxx.md) now correctly
...
- [`ansi_nchar()`](https://cli.r-lib.org/dev/reference/ansi_nchar.md),
  ...
  and the new
  [`ansi_strwrap()`](https://cli.r-lib.org/dev/reference/ansi_strwrap.md)
  as well handle wide Unicode correctly, according to their display
  width.

- [`boxx()`](https://cli.r-lib.org/dev/reference/boxx.md) can now add
...
- New [`cli_vec()`](https://cli.r-lib.org/dev/reference/cli_vec.md)
  function to allow easier formatting of collapsed vectors. It is now
  also possible to use styling to set the collapsing parameters
  ([\#129](https://github.com/r-lib/cli/issues/129)).

- New [`pluralize()`](https://cli.r-lib.org/dev/reference/pluralize.md)
...
- The default theme for
  [`cli_code()`](https://cli.r-lib.org/dev/reference/cli_code.md) output
