...
test_that("ansi_align", {
  txt <- "\033]8;;https://ex.com\033\\text\033]8;;\033\\"
  space3 <- strrep(" ", 3)
  space6 <- strrep(" ", 6)
  expect_equal(
    ansi_align(txt, 10),
...
test_that("ansi_chartr", {
  txt <- "1\033]8;;https://ex.com\033\\text\033]8;;\033\\2"
  expect_equal(
    ansi_chartr("12x0", "34yo", txt),
    ansi_string("3\033]8;;https://ex.com\033\\teyt\033]8;;\033\\4")
  )
})
...
test_that("ansi_strsplit", {
  txt <- "1\033]8;;https://ex.com\033\\te;xt\033]8;;\033\\2"
  expect_equal(
    ansi_strsplit(txt, ";"),
    list(ansi_string(c(
      "1\033]8;;https://ex.com\033\\te\033]8;;\033\\",
      "\033]8;;https://ex.com\033\\xt\033]8;;\033\\2"
    )))
  )
})
...
test_that("ansi_substr", {
  ...
  cases <- list(
    list(1, 3, "1\033]8;;https://ex.com\033\\\033[1mte\033[22m\033]8;;\033\\"),
    list(4, 6, "\033]8;;https://ex.com\033\\\033[1mxt\033[22m\033]8;;\033\\2"),
    list(3, 4, "\033]8;;https://ex.com\033\\\033[1mex\033[22m\033]8;;\033\\"),
    list(1, 10, "1\033]8;;https://ex.com\033\\\033[1mtext\033[22m\033]8;;\033\\2")
  )
...
test_that("ansi_tolower", {
  txt <- "Pre\033]8;;https://ex.com\033\\tEXt\033]8;;\033\\PoST"
  expect_equal(
    ansi_tolower(txt),
    ansi_string("pre\033]8;;https://ex.com\033\\text\033]8;;\033\\post")
  )
})
...
test_that("ansi_toupper", {
  ...
  expect_equal(
    ansi_toupper(txt),
    ansi_string("PRE\033]8;;https://ex.com\033\\TEXT\033]8;;\033\\POST")
  )
})
