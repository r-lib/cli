...
test_that("pb_elapsed", {
  ...
  mockery::stub(cli__pb_elapsed, ".Call", 1)
  expect_snapshot(cli__pb_elapsed())
  mockery::stub(cli__pb_elapsed, ".Call", 21)
  expect_snapshot(cli__pb_elapsed())
  mockery::stub(cli__pb_elapsed, ".Call", 58)
  expect_snapshot(cli__pb_elapsed())
  mockery::stub(cli__pb_elapsed, ".Call", 60 * 65)
  expect_snapshot(cli__pb_elapsed())
})
...
test_that("pb_elapsed_clock", {
  ...
  withr::local_options(cli__pb = list(start = 0, speed_time = 1))
  mockery::stub(cli__pb_elapsed_clock, ".Call", 1)
  expect_snapshot(cli__pb_elapsed_clock())
  mockery::stub(cli__pb_elapsed_clock, ".Call", 21)
  expect_snapshot(cli__pb_elapsed_clock())
  mockery::stub(cli__pb_elapsed_clock, ".Call", 58)
  expect_snapshot(cli__pb_elapsed_clock())
  mockery::stub(cli__pb_elapsed_clock, ".Call", 60 * 65)
  expect_snapshot(cli__pb_elapsed_clock())
})
...
test_that("pb_elapsed_raw", {
  ...
  withr::local_options(cli__pb = list(start = 0, speed_time = 1))
  mockery::stub(cli__pb_elapsed_raw, ".Call", 1)
  expect_snapshot(cli__pb_elapsed_raw())
  mockery::stub(cli__pb_elapsed_raw, ".Call", 21)
  expect_snapshot(cli__pb_elapsed_raw())
  mockery::stub(cli__pb_elapsed_raw, ".Call", 58)
  expect_snapshot(cli__pb_elapsed_raw())
  mockery::stub(cli__pb_elapsed_raw, ".Call", 60 * 65)
  expect_snapshot(cli__pb_elapsed_raw())
})

test_that("pb_eta", {
  expect_equal(cli__pb_eta(NULL), "")
  mockery::stub(cli__pb_eta, "cli__pb_eta_raw", NA_real_)
  expect_snapshot(cli__pb_eta(list()))
  mockery::stub(cli__pb_eta, "cli__pb_eta_raw", as.difftime(12, units = "secs"))
  expect_snapshot(cli__pb_eta(list()))
})
...
test_that("pb_eta_raw", {
  ...
  mockery::stub(cli__pb_eta_raw, ".Call", 0)
...
test_that("pb_eta_str", {
  ...
  mockery::stub(cli__pb_eta_str, "cli__pb_eta", "?")
  expect_snapshot(cli__pb_eta_str(list()))
  mockery::stub(cli__pb_eta_str, "cli__pb_eta", " 1s")
  expect_snapshot(cli__pb_eta_str(list()))
})
...
test_that("pb_rate", {
  ...
  mockery::stub(cli__pb_rate, "cli__pb_rate_raw", NaN)
  expect_snapshot(cli__pb_rate(list()))
  mockery::stub(cli__pb_rate, "cli__pb_rate_raw", Inf)
  expect_snapshot(cli__pb_rate(list()))
  mockery::stub(cli__pb_rate, "cli__pb_rate_raw", 1/10)
  expect_snapshot(cli__pb_rate(list()))
  mockery::stub(cli__pb_rate, "cli__pb_rate_raw", 12.4)
  expect_snapshot(cli__pb_rate(list()))
})

test_that("pb_rate_raw", {
  expect_equal(cli__pb_rate_raw(NULL), "")
  mockery::stub(cli__pb_rate_raw, "cli__pb_elapsed_raw", function(...) this)
  this <- 0
...
test_that("pb_rate_bytes", {
  ...
  mockery::stub(cli__pb_rate_bytes, "cli__pb_rate_raw", NaN)
  expect_snapshot(cli__pb_rate_bytes(list()))
  mockery::stub(cli__pb_rate_bytes, "cli__pb_rate_raw", Inf)
  expect_snapshot(cli__pb_rate_bytes(list()))
  mockery::stub(cli__pb_rate_bytes, "cli__pb_rate_raw", 0)
  expect_snapshot(cli__pb_rate_bytes(list()))
  mockery::stub(cli__pb_rate_bytes, "cli__pb_rate_raw", 1024)
  expect_snapshot(cli__pb_rate_bytes(list()))
  mockery::stub(cli__pb_rate_bytes, "cli__pb_rate_raw", 1024 * 23)
  expect_snapshot(cli__pb_rate_bytes(list()))
  mockery::stub(cli__pb_rate_bytes, "cli__pb_rate_raw", 1024 * 1024 * 23)
  expect_snapshot(cli__pb_rate_bytes(list()))
})
